                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="tel:+85285652541"><i className="fa fa-skype"></i> Skype</a>
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" placeholder="Message" value={this.state.message} onChange={this.handleInputChange} rows="12" />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
