...
//* Add new action creators in ActionCreators.js to enable the fetching 
//* of the leaders  information from the server and update the Redux store
...
export const postFeedback = (firstname, lastname, telnum, email, agree, contactType, message) => (dispatch) => {
    ...
    if (!agree) newFeedback.contactType = "";
